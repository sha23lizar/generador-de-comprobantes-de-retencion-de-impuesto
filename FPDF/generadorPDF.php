...
$pdf->AddPage();
    ...
    $pdf->Ln(3);
    $pdf->Cell(80);
    $pdf->Cell(30,5,'IMPUESTO AL VALOR AGREGADO (IVA)',0,0,'C');
    $pdf->Ln(3);
    $pdf->Cell(80);
    $pdf->SetFont('Arial','',7);
    $pdf->Cell(30,5,'Providencia Administrativa N'.utf8_decode("º").' SNAT/2015/0049 del 10/08/2.015',0,0,'C');
    $pdf->Ln(10);
    // FINAL - COMPROBANTE
...
// INICIO - DATOS DE LA INSTITUCION
    ...
    $pdf->Cell(18,5,'N'.utf8_decode("º").' FACTURA',1, 0,'C', 0);
    ...
    $pdf->Cell(8,5,"% ALIC.", 1, 0,'C', 0);
    $pdf->Cell(20,5,"IMPUSTO IVA",1, 0,'C', 0);
    $pdf->Cell(11,5,"% RETENIDO",1, 0,'C', 0);
    ...
    $pdf->Cell(18,5, $Filas['nroFactura'], 1, 0,'C', 0);
    ...
    $pdf->Cell(8,5, '%16', 1, 0,'C', 0);
    $pdf->Cell(20,5, $Filas['impuestoIva'], 1, 0,'C', 0);
    $pdf->Cell(11,5, '%75', 1, 0,'C', 0);
