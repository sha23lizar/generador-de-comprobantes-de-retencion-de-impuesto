                        ...
                        <table id="tabla" class="table table-striped table-bordered nowrap" style="width:100%">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Porcentaje de Iva</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLongTitle">Nuevo Comprobante IRS</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="impuesto-iva form-control impuestoIva" name='impuestoIva' placeholder="impuesto iva" value="2" min="0" max="100" required>
