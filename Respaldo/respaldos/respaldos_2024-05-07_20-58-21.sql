...
INSERT INTO respaldos VALUES ('101','','respaldo08052024-025738.sql','2024-05-07 20:57:38');
INSERT INTO respaldos VALUES ('102','-- Respaldo de la base de datos feb\n\n-- Respaldo de la tabla acompanantes\nCREATE TABLE `acompanantes` (\n  `ida` int(11) NOT NULL AUTO_INCREMENT,\n  `acompanante` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,\n  `cedula` int(11) NOT NULL,\n  `edad','respaldos_2024-05-07_20-57-41.sql','2024-05-07 20:57:41');
