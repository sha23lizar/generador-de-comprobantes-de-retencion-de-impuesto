...
if ($_POST["operacion"] == "crear") {
    ...
    if ($rif_existente > 0) {
        ...
        $stmt = $conexion->prepare("INSERT INTO proveedor(nombreProveedor, rifProveedor, direccionProveedor, seudonimo) VALUES (:nombreProveedor, :rifProveedor, :direccionProveedor, :seudonimo)");
