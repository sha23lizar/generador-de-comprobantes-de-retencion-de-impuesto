...
export class FormularioComprobantes {
    constructor(contentForm, modo, datatable) {
        ...
        this.urls = {
            guardar: "./includes/guardar_comprobante_isr.php",
            buscarUltimo: "./includes/buscarUltimoComprobante_isr.php",
            editar: "./includes/editarComprobante_isr.php"
        }
        ...
        this.porcentajeIva = this.form.querySelector(".impuesto-iva")
        ...
        if (valorBaseImponible) {
            this.porcentajeIva.value = (valorBaseImponible * 0.16).toFixed(2)
            this.ivaRetenido.value = (this.porcentajeIva.value * 0.75).toFixed(2)
        }
        ...
        this.porcentajeIva.addEventListener('input', (e) => {
                this.cambiarValoresIvas()
        })
    ...
    cambiarValoresIvas() {
        ...
        // this.porcentajeIva.value = (this.inputBaseImponible.value * 0.16).toFixed(2)
        this.ivaRetenido.value = (this.inputBaseImponible.value  * (this.porcentajeIva.value * 0.01)).toFixed(2)
    }
    ...
    obtenerData() {
        ...
        data.impuestoIva = this.porcentajeIva.value
    ...
    editar(comprobante) {
        ...
        this.porcentajeIva.value = comprobante.impuestoIva
        ...
        this.inputProveedor.value = comprobante.proveedor_isr
