...
if ($_POST["operacion"] == "crear") {
    ...
    $stmt_check_rif = $conexion->prepare("SELECT COUNT(*) FROM proveedor_isr WHERE rifProveedor = :rifProveedor");
    ...
    if ($rif_existente > 0) {
        ...
        $stmt = $conexion->prepare("INSERT INTO proveedor_isr(nombreProveedor, rifProveedor, direccionProveedor, seudonimo) VALUES (:nombreProveedor, :rifProveedor, :direccionProveedor, :seudonimo)");
...
if ($_POST["operacion"] == "editar") {
    ...
    */
    ...
    $stmt = $conexion->prepare("UPDATE proveedor_isr SET nombreProveedor = :nombreProveedor, rifProveedor = :rifProveedor, direccionProveedor = :direccionProveedor, seudonimo = :seudonimo WHERE id = :id");
